...
export function ContactClient({ email, phone, categories, packages, social = {} }: Props) {
        ...
        <FadeSection>
          <div>
            ...
            <div style={{ marginTop: '2rem', paddingTop: '2rem', borderTop: '1px solid var(--border)' }}>
              <p style={{ color: 'var(--muted)', fontSize: '0.85rem', fontWeight: 500, marginBottom: '1rem', letterSpacing: '0.05em', textTransform: 'uppercase' }}>Follow Us</p>
